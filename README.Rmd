...
```{r raw_exchange, warning = FALSE, fig.cap = "Exchange rates between US and Canada during the COVID-19 Pandemic", fig.alt = "Exchange rates between US and Canada during the COVID-19 Pandemic"}

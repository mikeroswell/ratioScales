---
title: "Ratio_scales_and_centinels"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Ratio_scales_and_centinels}
...
Dushoff](https://mac-theobio.github.io/dushoff.html), but I wrote this up to
understand them all), which might help me make more sense of the data and think
more clearly about the risks I take.
...
values on the "ratio scale:" instead of "69.3," "138.6," and "207.9," and
translating, I'll have an easier time when I see "2," "4," and "8."

## Ratio scales

```{r centinels and ratios}

...
percentage difference relative to the starting value.  Here, we visualize
changes in home values, where for each region the Zillow Home Value Index is
computed, the baseline value is the value in the first reporting period.
...
100% (and much bigger than gaining 50%).

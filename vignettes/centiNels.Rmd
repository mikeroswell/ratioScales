...
all ratio-based changes linear.  For now, let's go with it's "excellent." 
...
An alternative is to become more comfortable with viewing data on a
logarithmic scale. Lots of bases can make sense for logarithms (e.g., 2, 10, or
e); here we explore natural logarithms (base e = `exp(1)`). To do this, let's
indulge some nomenclature fun, then see what it can do for us.
